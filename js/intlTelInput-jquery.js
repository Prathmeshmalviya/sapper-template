...
(function (factory) {
  ...
  var defaults = {
    ...
    // the countries at the top of the list. defaults to India (in)
    //  add another counrty in top list ADD in => preferredCountries: ["in"],
          ...
          value: function _setInitialState() {
            ...
            if (dialCode && !isRegionlessNanp) {
              ...
              if (initialCountry) {
                ...
                if (dialCode && isRegionlessNanp) {
                  // has intl dial code, is regionless nanp, and no initialCountry, so default to IN (INDIA)
                  this._setFlag("in");
                } else {
